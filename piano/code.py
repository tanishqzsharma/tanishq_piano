...
str = StringVar()
str.set("Your key name will be displayed here")
...
# Label
Label(abc1, text="Piano Musical Keys", font=("arial", 25, "bold"), padx=8, pady=8, bd=4, width=59, bg="pink",
      fg="white", height=1,
      justify=CENTER).grid(row=0, column=0, columnspan=11)

display = Entry(abc1, textvariable=str, font=("arial", 18, "bold"), width=35, bd=34, bg="pink", fg="black",
...
btnSpace1 = Button(abc2, state=DISABLED, height=6, width=2, bg="pink", relief=FLAT)
...
btnSpace5 = Button(abc2, state=DISABLED, height=6, width=2, bg="pink", relief=FLAT)
